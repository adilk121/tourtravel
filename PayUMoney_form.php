      ...
      <table align="center">
        <tbody>
          <tr>
			...
			<!--<p style="color:#B7B7B7;font-size:17px; font-family:Arial, Helvetica, sans-serif">Please Click on the Button to Procced the Payment</p>-->
			<p style="color:#6B6B6B;font-size:20px; font-family:Arial, Helvetica, sans-serif">Please do not refresh or close the tab</p>
			</td>
          </tr>
        ...
        <tr>
          <?php if(!$hash) { ?>
            <td colspan="4">
                ...
                <!--<button style="width:300px; height:50px; margin-left:113%; background:green; color:white; border:none; font-size:20px;" type="submit">Procced To Pay</button>-->
                </td>
          <?php } ?>
        </tr>
      </table>
