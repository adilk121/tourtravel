...
<div class="tsp-main">
    ...
    <div class="tsp-header-main">
      <div class="container">
        <div class="row">
          <div class="tsp-logo col-md-2 col-sm-2 col-xs-10"> <a href="index.html"> <img src="images/logoincredible.jpg" title="India Tourism Incredible" alt="India Tourism Incredible" class="logod"> </a> </div>
        ...
        <li><a href="gallery.html">Gallery</a></li>
          ...
          <div class="tsp-logo col-md-3 col-sm-3 col-xs-12 amiZ" style="z-index:-999">
            ...
            <div class="col-md-12 col-xs-4">
              <p><a href="tel:09999444497" class="amiMbl">09999444497</a></p>
            </div>
...
<?php /*?><input type="hidden" name="pack_cost" value="<?=$_REQUEST['cost']?>"  /><?php */?>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group tsp-no-padding-right tsp-full-xs">
			<label>Fare</label>
			<input type="text" name="pack_cost" readonly id="pack_cost" value="<?=$_REQUEST['cost']?>"  required>
		</div>
        </div>
        <div class="col-md-6">
        <div class="form-group tsp-no-padding-right tsp-full-xs">
            ...
            <aside class="tsp-widget-footer">
              ...
              <div class="tsp-content-item">
                ...
                <ul class="tsp-social-footer hidden-xs">
                  <li> <a href="https://www.facebook.com/india.tourism.7528" target="_blank" title="Facebook"><i class="fa fa-facebook-square"></i></a> </li>
