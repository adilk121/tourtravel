            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="site-heading">
                        <h2>Why Choose <?=$compDATA['admin_company_name']?>?</h2>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-choose">
                        ...
                        <div class="choose-image">
                            <img src="<?=$site_url?>/assets/img/choose-1.png" alt="Safe Travel" />
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="single-choose">
                        <p>02</p>
                        <div class="choose-image">
                            <img src="<?=$site_url?>/assets/img/choose-2.png" alt="Awesome Guide" />
                        </div>
                        <div class="choose-desc">
                            <h3>Awesome Guide</h3>
                            <p>printing and typesetting industry has been printing the industry’s ipsum</p>
                ...
                <div class="col-lg-4">
                    <div class="single-choose">
                        <p>03</p>
                        <div class="choose-image">
                            <img src="<?=$site_url?>/assets/img/choose-3.png" alt="Save Money" />
                        </div>
                        <div class="choose-desc">
                            <h3>Save Money</h3>
                            <p>printing and typesetting industry has been printing the industry’s ipsum</p>
