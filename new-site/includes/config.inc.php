...
if (LOCAL_MODE) {
	...
	$ARR_CFGS["db_name"] = 'agra_tour_bus';
    $ARR_CFGS["db_user"] = 'root';
    $ARR_CFGS["db_pass"] = '';
	define('SITE_SUB_PATH', '/rehan/agra-tour-bus');
} else {
    // Server database settings
	$ARR_CFGS["db_host"] = 'localhost';
	$ARR_CFGS["db_name"] = 'indiatou_new_site';
    $ARR_CFGS["db_user"] = 'indiatou_new_site';
    $ARR_CFGS["db_pass"] = 'new_site@12345';
	define('SITE_SUB_PATH', '/indiatourismincr');
}
...
define('SITE_NAME', 'Shoefactory');
define('TEST_MODE', false);

define('DEF_PAGE_SIZE', 250);
define('ADMIN_DIR', 'admin');
define('ADIM_EMAIL','oroglow.india@gmail.com');
