...
<td class="text-center v-middle"><a href="<?=$site_url?>/<?=$line_raw["site_pages_url"]?>.html" target="_blank" class="btn btn-link">Click Here <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
</a></td>
