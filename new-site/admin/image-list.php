...
$image->source_path = '../gallery_images/'.$imgNAME; 
$ext = substr($image->source_path, strrpos($image->source_path, '.') + 1);
// indicate a target image
$image->target_path = '../gallery_images/thumb/'.$imgNAME;
// resize
...
<?php			
			  $sql_fetch = db_query("select * from tbl_image_gallery where 1 order by image_id asc");
             ...
             <img src="../gallery_images/<?=$DATA['image_name']?>" class="img-thumbnail" width="140" height="140" />
