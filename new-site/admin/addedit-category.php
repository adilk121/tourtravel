...
<p style="color:red; font-weight: bold; font-size: 10px; ">Image Size:- Width:300px, Height:300px;</p>
</div>
...
<div class="form-group col-lg-12">
                                 <label>Category Shared Count</label>
<input type="text" class="form-control" placeholder="Enter Shared Count" name="category_shared_count" id="category_shared_count"  value="<?=$category_shared_count?>">
                              </div>      -->                       
