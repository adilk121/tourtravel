...
$sql = "select * from  tbl_header_flash   where 1 AND header_flash_type='Left'";
...
<td class="text-center v-middle"><a href="<?=SITE_WS_PATH?>" target="_blank"><img src="../flash_images/<?=$header_flash_image_name?>" height="100" width="75"  style="border:solid thin #ccc;padding:5px;"></a></td>                            
