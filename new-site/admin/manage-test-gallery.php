         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  ...
                  <a href="addedit-test-gallery.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
...
<td class="text-center v-middle"><a href="<?=SITE_WS_PATH?>" target="_blank"><img src="../header_files/<?=$header_logo?>" height="100" width="75"  style="border:solid thin #ccc;padding:5px;"></a></td>                            
                                     
<td class="text-center v-middle"><?=$line_raw["header_image_title"]?></td>
<td class="text-center v-middle">TEST</td>

                                     

<td class="text-center v-middle">
<?php if($line_raw["header_status"]=="Active"){?>
<a href="manage-test-gallery.php?st=1&pid=<?=$line_raw["header_id"]?>"><span class="label-custom label label-default">Active</span></a>
<?php }else{?>
<a href="manage-test-gallery.php?st=0&pid=<?=$line_raw["header_id"]?>"><span class="label-danger label label-default">Inactive</span></a>
<?php }?>

</td>
                                       <td class="text-center v-middle">
<a href="addedit-test-gallery.php?edit_header_id=<?=$line_raw["header_id"]?>"><button type="button" class="btn btn-add btn-sm" ><i class="fa fa-pencil"></i></button>
</a>                                          
