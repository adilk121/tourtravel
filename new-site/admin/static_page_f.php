...
<!-- <input type="text" class="form-control" placeholder="Enter Title" name="site_pages_title" id="site_pages_title" value="<?=$site_pages_title?>" > -->  
    <select name="site_pages_link" id="site_pages_link" class="form-control" >
          ...
          <option value="bus-tour-packages" <?php if($site_pages_link=='bus-tour-packages'){ ?> selected="selected" <? } ?>>bus-tour-packages.php</option>
          <option value="blogs" <?php if($site_pages_link=='blogs'){ ?> selected="selected" <? } ?>>blogs.php</option>
          <option value="bus-hire" <?php if($site_pages_link=='bus-hire'){ ?> selected="selected" <? } ?>>bus-hire.php</option>
          <option value="disclaimer" <?php if($site_pages_link=='disclaimer'){ ?> selected="selected" <? } ?>>disclaimer.php</option>
          ...
          <option value="refund-policy" <?php if($site_pages_link=='refund-policy'){ ?> selected="selected" <? } ?>>refund-policy.php</option>
 ...
 <?php if($site_pages_link=='about-us' /*|| $site_pages_link=='customized-work' || $site_pages_link=='enquiry' || $site_pages_link=='services' || $site_pages_link=='career'*/  ){ ?>
...
<input type="file" name="file" id="file" />
 <p style="color:red; font-weight: bold; font-size: 10px;">Image Size:- Width:601px, Height:478px</p> 
</div>
<?php }?>
