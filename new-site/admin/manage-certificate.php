...
//		 $imageDupli = db_scalar("select count(*) from tbl_category_image where 1 and category_certificate_image_name='$imgName'"); 
//		 if($imageDupli > 0){
...
if (move_uploaded_file($_FILES['file']['tmp_name'][$i],"../our_certificate/$imgNAME")) {


//////////////////////////////// FOR SMALL  PRODUCT THUMB //////////////////////////////
$image = new Zebra_Image(); 
$image->source_path = '../our_certificate/'.$imgNAME; 
$ext = substr($image->source_path, strrpos($image->source_path, '.') + 1);
// indicate a target image
//$image->target_path = '../our_certificate/thumb/'.$imgNAME;
// resize
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  ...
                  <small>Our Certificate List</small>
...
<span class="count-num">Total : <?=db_scalar("SELECT COUNT(certificate_id) FROM tbl_certificate WHERE 1")?></span>
                     ...
                     <div class="panel panel-bd lobidrag" data-edit-title='false' data-close='false' data-reload='false'>
                        ...
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Our Certificate Image List</h4>
                              </a>
                           </div>
                        </div>
...
<?php			
             ...
             <img src="../our_certificate/<?=$DATA['certificate_image_name']?>" class="img-thumbnail" style="width:120px; height:120px;" />
            <span style="font-weight:bold;"><?=$DATA['image_title']?></span>
	
    <div class="col-lg-12 text-center" style="margin-top:10px" ><a href="manage-certificate.php?DelID=<?=$DATA['certificate_id']?>"><i class="fa fa-trash fa-2x" style="color:#F00"></i></a></div>
          </div>		  
			 <? }} ?>
			 <div class="cb"></div>
			 </div>
