...
<h1>SEO & Site Features</h1>
<small>SEO & Site Features Settings</small>
</div>
...
<div class="btn-group" id="buttonexport">
  <a href="#">
     <h4 style="color:grey !important;"></h4>Enable/Disable SEO & Site Features</h4>
  </a>
</div>
</div>
...
<div class="row">
<div class="col-lg-12" style="padding-left:0px;">
<textarea type="text" name="admin_live_chat_code" id="admin_live_chat_code" style="resize:none;" rows="10" class="form-control" /><?=$data_new['admin_live_chat_code']?></textarea>
</div>
</div>
</div>
