...
<li class="">
<a href="<?=$site_url?>" target="_blank"><i class="fa fa-globe"></i><span>Visit Website
...
<span class="pull-right-container">
    ...
    <?php if(check_access($_SESSION['ADMIN_ACCESS'],"1")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
       <li class="">
...
<span>SEO & Site Features</span>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"2")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                   <li class="">
...
<?}?>             
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"3")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>      
...
<?}?>                  
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"22")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>                     
          <li class="">
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"4")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>                     
          <li class="">
                    <!--   <a href="category_list.php"> -->
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"23")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>                     
          <li class="">
                    <!--   <a href="category_list.php"> -->
...
<?}?>
          ...
          <?php if(check_access($_SESSION['ADMIN_ACCESS'],"5")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>          
         <li class="">
...
<span>Manage Blog</span>
          ...
          <?php if(check_access($_SESSION['ADMIN_ACCESS'],"6")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>          
...
<?}?> 
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"7")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                <li class="treeview">
                     <a href="#">
...
<?}?>
                   ...
                   <?php if(check_access($_SESSION['ADMIN_ACCESS'],"8")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?> 
                   <li class="">
...
<span>Manage Rating</span>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"9")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                  <li class="">
...
<?php if(check_access($_SESSION['ADMIN_ACCESS'],"10")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>          
                 <li class="">
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"11")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"12")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                   <li class="">
                     <a href="video-list.php">
                     <i class="fa fa-video-camera" aria-hidden="true"></i> <span>Manage Video</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>                     
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"13")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                  <li class="">
...
<?}?>
          ...
          <?php if(check_access($_SESSION['ADMIN_ACCESS'],"14")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                 <li class="">
                  ...
                  <?}?>
                         ...
                         <?php if(check_access($_SESSION['ADMIN_ACCESS'],"15")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                  <li class="">
              ...
              <?}?>
                    ...
                    <?php if(check_access($_SESSION['ADMIN_ACCESS'],"16")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                

                        <li class="">
                     <a href="manage-our-client.php">
                     <i class="fa fa-picture-o" aria-hidden="true"></i> <span>Manage Client Logo</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>                     
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"17")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>

                   <li class="">
                     <a href="manage-certificate.php">
                     <i class="fa fa-picture-o" aria-hidden="true"></i> <span>Manage Certificate</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>                     
                  ...
                  <?}?>
                    ...
                    <?php if(check_access($_SESSION['ADMIN_ACCESS'],"18")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
...
<?}?>
  ...
  <?php if(check_access($_SESSION['ADMIN_ACCESS'],"19")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
                    <li class="">
                     <a href="manage-user.php">
                     <i class="fa fa-users" aria-hidden="true"></i> <span>Manage Sub Admin</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>                     
...
<!-- <li class="">
<a href="manage-our-team.php">
<i class="fa fa-users" aria-hidden="true"></i> <span>Manage Our Team</span>
<span class="pull-right-container">
<i class="fa fa-angle-left pull-right"></i>
</span>
</a>                     
  ...
  -->
    <?php if(check_access($_SESSION['ADMIN_ACCESS'],"20")=='true' || $_SESSION['sess_admin_type']=='Admin'){ ?>
