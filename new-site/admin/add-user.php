...
$count=db_scalar("select count(*) from tbl_registration where 1 and reg_email='$reg_email'");
	if($count>=1){
 ...
 $sql="insert into tbl_registration set 
		   ...
		   reg_shipping_name='$reg_name',
		   reg_shipping_email='$reg_email',
		   reg_shipping_mobile_no='$reg_mobile_no',
...
<div style="margin-top:20px;"><span style="font-weight:bold;">Dear</span><span style="color:#e8410d;font-weight:bolder;"> '.ucfirst($reg_name).'</span>,</div><br>
...
<td width="82%" style="line-height:25px;">User Name: <strong>'.$reg_email.'</strong><br>Password: <strong>'.$reg_pass.'</strong><!--<div style="margin-top:7px;"><a  href="" style="font-size:11px;color:#00f;text-decoration:underline;">change your password</a></div>--></td>
</tr></tbody></table>
</div> 
<br>				
<div style="padding-top:5px;" >				
<p style="margin-top:15px;"><a href="'.SITE_WS_PATH.'/activation.php?id='.base64_encode($reg_email).'">Click here To Activate Your Account.</a></p>
...
if($reg_id!=""){
$sql="SELECT * FROM tbl_registration WHERE 1 AND reg_id='$reg_id'";
...
<div class="col-lg-10 "><input type="text" name="reg_email" id="reg_email2" disabled   value="<?=$recRegd['reg_email']?>" placeholder="Your email/user id" class="form-control unicase-form-control text-input"  >
...
<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">Email&nbsp;Address&nbsp;<span>*</span></label></div>
<div class="col-lg-10 "><input type="text" name="reg_email" id="reg_email"   value="" placeholder="Your email/user id" class="form-control unicase-form-control text-input" onkeyup="check_email()" >

<span class="err" id="error_reg_email"></span>   
...
<div class="col-lg-10 "><input type="text" name="reg_pass" id="reg_pass" value="<?=$recRegd['reg_pass']?>" placeholder="Your name" class="form-control unicase-form-control text-input"></div>
</div>


<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">Name <span>*</span></label></div>
<div class="col-lg-10 "><input type="text" name="reg_name" id="reg_name" value="<?=$recRegd['reg_name']?>" placeholder="Your name" class="form-control unicase-form-control text-input"></div>
</div>



<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">Phone <span>*</span></label></div>
<div class="col-lg-10 "><input type="text" class="form-control unicase-form-control text-input" name="reg_mobile_no" id="reg_mobile_no" value="<?=$recRegd['reg_mobile_no']?>" placeholder="Your mobile"></div>
</div>

<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">Address <span>*</span></label></div>
<div class="col-lg-10 "><textarea name="reg_address" id="reg_address" rows="2" class="form-control theme-bdr" placeholder="Your Address"><?=$recRegd['reg_address']?></textarea>		</div>
</div>

<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">Zip Code <span>*</span></label></div>
<div class="col-lg-10 "><input type="text" placeholder="Enter zip/pin code" class="form-control unicase-form-control text-input" name="reg_zip_code" id="reg_zip_code" value="<?=$recRegd['reg_zip_code']?>"></div>
</div>


<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">City <span>*</span></label></div>
<div class="col-lg-10 "><input type="text" placeholder="Enter city " name="reg_city" id="reg_city" value="<?=$recRegd['reg_city']?>" class="form-control unicase-form-control text-input"></div>
</div>



<div class="form-group col-lg-12">
<div class="col-lg-2 "><label class="info-title" for="exampleInputEmail2">State <span>*</span></label></div>
<div class="col-lg-10 "><input type="text" placeholder="Enter state" class="form-control unicase-form-control text-input" name="reg_state" id="reg_state" value="<?=$recRegd['reg_state']?>"></div>
</div>
...
<div class="col-lg-10 ">
<select class="form-control for-select-box" name="reg_country" id="reg_country">
...
<?php if($recRegd['reg_country']!=""){?>
<option value="<?=$recRegd['reg_country']?>" selected><?=$recRegd['reg_country']?></option>
<?php }?>                                    
...
if(email==''){
$('#error_reg_email').html("Please enter only alphabets !")
$('#reg_email').val('');
}else if(!email.match(mailformat)){
$('#error_reg_email').html("You have entered an invalid email address!")
$('#reg_email').val('');
}else{
...
$.ajax({
type:'POST',
url:"../check-email.php?email="+email,
...
if(trim(document.getElementById('reg_name').value)==0){		
alert("Enter Your Name !");
document.getElementById('reg_name').focus();
return false;
}	
if (!document.getElementById('reg_name').value.match(/^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])*$/)){
...
var mobno=trim(document.getElementById('reg_mobile_no').value);
if(trim(document.getElementById('reg_mobile_no').value)==0){
	alert("Enter your mobile no.!");
	document.getElementById('reg_mobile_no').focus();
	return false;
}
if(isNaN(document.getElementById('reg_mobile_no').value)){
...
if(trim(document.getElementById('reg_address').value)==0){
 ...
 if(trim(document.getElementById('reg_zip_code').value)==0){
	alert("Enter your pin/zip code !");
	document.getElementById('reg_zip_code').focus();
	return false;
 }
 
  if(trim(document.getElementById('reg_city').value)==0){
	alert("Enter your city name !");
	document.getElementById('reg_city').focus();
	return false;
 }


  if(trim(document.getElementById('reg_state').value)==0){
  ...
  if(trim(document.getElementById('reg_coutry').value)==0){
	alert("Enter your country name !");
	document.getElementById('reg_coutry').focus();
	return false;
 }
