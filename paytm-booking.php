  ...
  <main>
    <section class="tsp-content-contact-page">
      <div class="container tsp-no-padding">
        <div class="col-lg-12" id="pack-detail"><span id="pack">
          <?=$_REQUEST['pack']?>
          </span>
          <?php if($_REQUEST['type']!='None'){?>
          <span id="type">
          <?=$_REQUEST['type']?>
          </span>
          <?php }?>
          <span id="cost">
          <?="<span id='inr'>Rs.</span>".$_REQUEST['cost']?>
          </span></div>
        <div class="row">
          <div>
            <div class="col-md-6">
              <form name="ContactFrm" action="proceed1.php" method="post" enctype="multipart/form-data" onsubmit="return EnqValidation();">
                ...
                <div class="tsp-form-site">
                  ...
                  <div class="form-group tsp-no-padding-right tsp-full-xs">
                    ...
                    <select  class="form-sec" name="pickup_points" id="pickup_points" required>
                      <option value="0">Select Pickup Ponts</option>
                    ...
                    <select  class="form-sec" name="pickup_points" id="pickup_points" required>
                      ...
                      <option value="New Delhi Railway Station - 09:15 am">New Delhi Railway Station - 09:15 am</option>
                  ...
                  <div><input type="radio" name="payment_option" id="payment_option" value="PAYU" checked style="width:6%; float:left; height:22px; margin-top:13px;"> <img src="images/payu.png" style="width:150px; height:45px; float:left;vertical-align:top;"></div>
                  <div class="clearfix"></div>
                  <div style="margin-top:8px;"><input type="radio" name="payment_option" id="payment_option" value="PAYTM" style="width:6%; float:left; height:22px; margin-top:13px;"> <img src="images/Paytm_logo.png" style="width:150px; height:45px; float:left;vertical-align:top;"></div>
                  </div>
                  <div class="clearfix"></div>
                </div>
                <center style="margin-top:10px;">
<input type="submit" name="EnqSubmit" value="Pay Now">
</center>
              </form>
            </div>
            <div class="col-md-6">
              <div class="tsp-content"> <img src="images/enquiry.png" width="100%" alt="India Tourism Incredible" title="India Tourism Incredible"> </div>
            </div>
          </div>
        </div>
      </div>
